...
def unique_phone(is_phone_exist, phone):
    if is_phone_exist(phone):
        phone1=get_phone()
        if is_phone_exist(phone1):
            return unique_phone(is_phone_exist, phone1)
        else:
            return phone1
    else:
        return phone
...
def add_record():
    ...
    phone=get_phone()
    if is_phone_exist(phone):
        test=unique_phone(is_phone_exist, phone)
        write_phone(name, test)
    else:
        write_phone(name, phone)
